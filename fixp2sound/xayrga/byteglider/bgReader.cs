...
namespace xayrga.byteglider
{
    public unsafe class bgReader : BinaryReader
    {
        ...
        public long RelativeToAbsolutePosition(long relative)
        {
            return RelativeOffset + relative;
        }

        public int RelativeToAbsolutePosition(int relative)
        {
            return (int)(RelativeOffset + relative);
        }
